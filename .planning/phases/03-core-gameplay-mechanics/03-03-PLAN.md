...
<task type="auto">
  ...
  <action>
    ...
    - Create `ecs/systems/ui_system.py`:
        ...
        - The Header should display the "Global Round" counter and the "Current Turn" status.
...
<task type="auto">
  ...
  <action>
    ...
    - Add logic to highlight the currently selected action and grey out unavailable ones.
  </action>
