...
must_haves:
  ...
  artifacts:
    - path: "ecs/components.py"
      provides: "SlotType, Equippable, Equipment, EffectiveStats"
...
<task type="auto">
  ...
  <action>
    Add the following to ecs/components.py:
    ...
    4. EffectiveStats component: mirroring Stats fields (power, defense, max_hp, max_mana, perception, intelligence).
  </action>
  <verify>Check ecs/components.py for new definitions.</verify>
  <done>All 4 components/enums are defined correctly.</done>
</task>
