...
from game.components import AI, AIBehaviorState, AIState, Alignment, Blocker, ChaseData, PathData, Position, Stats
...
def test_npc_waits_if_path_blocked():
    ...
    npc2 = esper.create_entity(Position(1, 0), Blocker())
