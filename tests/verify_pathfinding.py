...
def test_obstacle_avoidance():
    ...
    map_container.layers[0].tiles[1][1].walkable = False
    map_container.layers[0].tiles[0][1].walkable = False
...
def test_unreachable():
    ...
    # Box in (4,4)
    map_container.layers[0].tiles[3][4].walkable = False
    map_container.layers[0].tiles[4][3].walkable = False
    map_container.layers[0].tiles[3][3].walkable = False
