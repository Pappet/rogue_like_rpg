...
class CharacterWindow(UIWindow):
    ...
    def draw(self, surface):
        ...
        # Draw title
        title_text = self.title_font.render("Character Sheet", True, (255, 255, 255))
        surface.blit(title_text, (box_x + 20, box_y + 20))
        
        # Draw Equipment label
        equip_label = self.title_font.render("Equipment", True, (255, 255, 255))
        ...
        try:
            ...
            error_text = self.font.render("Stats not found.", True, (255, 100, 100))
        ...
        try:
            ...
            for i, slot in enumerate(SlotType):
                ...
                slot_text = self.font.render(f"{slot_label}:", True, (150, 150, 150))
                item_text = self.font.render(item_name, True, (255, 255, 0) if item_id else (100, 100, 100))
                
                surface.blit(slot_text, (separator_x + 20, box_y + 100 + i * 40))
                surface.blit(item_text, (separator_x + 160, box_y + 100 + i * 40))
                
        except KeyError:
            error_text = self.font.render("Equipment not found.", True, (255, 100, 100))
            surface.blit(error_text, (separator_x + 20, box_y + 100))

        # Footer hint
        hint_text = self.font.render("[ESC/C] Close", True, (150, 150, 255))
